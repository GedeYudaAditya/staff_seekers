...
class AdminController extends Controller
{
    ...
    public function transactionProcess(Request $request, Transaction $transaction)
    {
        $validateData = $request->validate(
            [
        ...
        try {
            //code...
            // dd($transaction->id);
            Transaction::where('id', $transaction->id)->update($validateData);
            DB::commit();
            return back()->with('success', 'data updated successfully');
        } catch (\Throwable $th) {
            // throw $th;
